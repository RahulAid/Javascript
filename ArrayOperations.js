// 1)
// toString() - it is used to convert elements into the string type
...
// ***************
// 5)
// push - it adds new element in an array at the end 
...
// ***************
// 6)
// shift() - it removes the first elmeent from the array 
// let arr=[4, 1, 3, 2];
// let store=arr.shift();
// console.log(store);

// unshift() - it adds the new item in the beginning 
// let arr=[4, 1, 3, 2];
...
// ***************
// 7)
// reverse - it is changing the index like last to first and so on
